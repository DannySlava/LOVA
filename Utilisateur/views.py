...
def accueil_client(request):
    ...
    client_id = request.session['id_client']
    client = Client.objects.get(id_client=client_id)
    
    return render(request, 'Client/accueil_client.html', {'client': client})
...
def connexion(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect('accueil_client')  # Redirige vers la page d'accueil du client
